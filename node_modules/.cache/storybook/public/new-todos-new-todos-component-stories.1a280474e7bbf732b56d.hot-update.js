  ...
  addTodo() {
    if (this.todoForm.valid) {
      ...
      if (this.selectedTodo) {
        ...
        // Add new todo
        const generatedId = this.todos.length > 0 ? Math.max(...this.todos.map(todo => todo.id)) + 1 : 1;
        const todoToAdd = {
          id: generatedId,
          name: newTodo.name,
...
//# sourceMappingURL=new-todos-new-todos-component-stories.1a280474e7bbf732b56d.hot-update.js.map