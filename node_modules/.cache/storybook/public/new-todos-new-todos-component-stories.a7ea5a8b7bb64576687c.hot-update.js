...
let NewTodosComponent = class NewTodosComponent {
  ...
  constructor(fb, todoEditService) {
    ...
    this.todos = [];
    this.selectedTodo = this.todoEditService.selectedTodo$.subscribe(selectedTodo => {
...
//# sourceMappingURL=new-todos-new-todos-component-stories.a7ea5a8b7bb64576687c.hot-update.js.map