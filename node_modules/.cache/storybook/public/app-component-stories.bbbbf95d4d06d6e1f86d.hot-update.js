  ...
  markCompleted(todo) {
    if (todo.id !== undefined) {
      this.todoService.markAsComplete(todo.id, !todo.complete).subscribe(() => {
        // Update the todo's status locally
        todo.complete = !todo.complete;
      });
    }
  }
  clearCompleted() {
    const completedTodo = this.allTodos.find(todo => todo.id === todoId && todo.complete === true);
    if (completedTodo) {
      this.todoService.deleteTodo(todoId).subscribe(() => {
        this.allTodos = this.allTodos.filter(todo => todo.id !== todoId);
      });
    } else {
      console.log('Todo with id ' + todoId + ' is not completed. Cannot delete.');
    }
  }
...
}), (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__metadata)("design:paramtypes", [_app_todo_service_service__WEBPACK_IMPORTED_MODULE_2__.TodoServiceService])], AppComponent);

/***/ })

});
//# sourceMappingURL=app-component-stories.bbbbf95d4d06d6e1f86d.hot-update.js.map