...
let NewTodosComponent = class NewTodosComponent {
  ...
  ngOnChanges(changes) {
    if (changes["selectedTodo"] && changes["selectedTodo"].currentValue) {
      // Update form control value when a new todo is selected for editing
      this.todoForm.patchValue({
        name: changes["selectedTodo"].currentValue.name
      });
    } else {
      // Reset form when no todo is selected
      this.todoForm.reset();
    }
  }
  // addTodo() {
...
//# sourceMappingURL=new-todos-new-todos-component-stories.5af49594155368d1aa53.hot-update.js.map